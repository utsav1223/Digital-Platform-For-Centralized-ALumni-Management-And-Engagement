...
export default function StudentForgotPassword() {
    ...
    const handleSendOTP = async (e) => {
        ...
        try {
            ...
            // ✅ REDIRECT
            setTimeout(() => {
                navigate(`/student/reset-password?regNo=${regNo}`);
            }, 1500);
                ...
                <div className="p-8 pt-10">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-gray-500 text-sm mt-2 text-center leading-relaxed">
                            Enter your Registration Number to recover access.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSendOTP} className="space-y-6">
                        <div>
                            <label htmlFor="regNo" className="block text-sm font-medium text-gray-700 mb-1.5 ml-1">
                                Registration Number
                            </label>

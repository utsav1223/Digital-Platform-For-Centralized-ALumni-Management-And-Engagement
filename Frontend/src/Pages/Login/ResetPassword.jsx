...
export default function ResetPassword() {
    ...
    const handleReset = async (e) => {
        ...
        setError("");
        setSuccess("");
        setResendMessage(""); // Clear resend msg if they try to submit
        ...
        try {
            const res = await fetch(
                "http://localhost:8000/api/alumni/auth/reset-password",
                {
                    method: "POST",
    ...
    return (
        // MAIN CONTAINER: Removed bg-cover from here to fix the scrolling issue
        <div className="relative min-h-screen flex items-center justify-center px-4 py-12">
            ...
            {/* 3. SCROLLABLE CARD CONTENT (z-10 puts it above the fixed background) */}
                ...
                <div className="p-8 pt-10">
                    ...
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <p className="text-gray-500 text-sm text-center mt-1">
                            Secure account for <span className="font-semibold text-blue-600">{email}</span>
                        </p>
                    </div>

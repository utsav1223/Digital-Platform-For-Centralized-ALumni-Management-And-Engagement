...
const Sidebar = ({
  ...
  /* ---------------- MENU ITEMS (ALIGNED WITH DASHBOARD) ---------------- */
  const menuItems = [
    { id: "dashboard", icon: Home, label: "Dashboard" },
    { id: "jobs", icon: Briefcase, label: "Jobs" }, // ✅ FIXED
    ...
    >
      ...
      <div className="p-4 border-t border-slate-100 relative">
        {showProfileDropdown && (
          <div
            ref={dropdownRef}
            className="absolute bottom-full left-4 right-4 mb-2 bg-white rounded-xl shadow-xl border border-slate-200"
          >
            ...
            <div className="p-1">
              <button
                ...
                className="w-full px-3 py-2 text-sm flex items-center gap-2 hover:bg-slate-50 rounded-lg"
              >
            ...
            <div className="p-1 border-t">
              <button
                ...
                className="w-full px-3 py-2 text-sm flex items-center gap-2 text-red-600 hover:bg-red-50 rounded-lg"
              >
        ...
        <button
          ...
          className="w-full flex items-center gap-3 p-2 rounded-xl hover:bg-slate-50 border"
        >
          <div className="w-9 h-9 bg-indigo-100 text-indigo-700 flex items-center justify-center rounded-lg font-bold">
            {userData.initial}
          </div>

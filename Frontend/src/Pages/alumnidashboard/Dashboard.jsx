...
import { getLoggedInAlumni } from "../../api/authAPI";

const Dashboard = ({ setActiveTab }) => {

  // ⭐ NEW: State for alumni profile
  const [alumni, setAlumni] = useState(null);
  const [completion, setCompletion] = useState(0);

  // ⭐ NEW: Fetch alumni session profile
  useEffect(() => {
    getLoggedInAlumni().then(res => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* ⭐ NEW: Dynamic Profile Completion Card */}
          {/* ⭐ NEW: Dynamic Profile Completion Card */}
          {completion < 100 && (
              ...
              <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-1">
                    Welcome back, {alumni?.fullName?.split(" ")[0] || "Alumni"}! 👋
                  </h3>
                ...
                <button
                  ...
                  className="bg-white text-blue-700 px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-blue-50 transition-colors shadow-sm whitespace-nowrap"
                >
                  Complete Profile
                </button>
              </div>

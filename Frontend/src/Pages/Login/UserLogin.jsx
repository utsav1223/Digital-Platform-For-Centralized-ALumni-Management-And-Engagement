        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden relative h-auto md:min-h-[650px] flex flex-col md:block">
          ...
          >
            <FormContent 
                ...
                isMobile={!isDesktop} 
                targetRole="student"
                onLoginSuccess={() => setIsLoggedIn(true)} // PASS SUCCESS HANDLER
            />
          </motion.div>
...
function FormContent({ role, subtitle, setRole, isMobile, targetRole, onLoginSuccess }) {
  ...
  // 2. FETCH INTEGRATION (Updated with user logic)
const handleLogin = async (e) => {
  ...
  try {
    const endpoint = role.toLowerCase();   // "alumni" or "student"
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 md:py-3.5 bg-slate-50 rounded-xl border border-slate-200 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none font-medium text-slate-700 placeholder:text-slate-400"
            />
          </div>
        </div>
